  ...
  App.uiNotifications = function( ){  
    ...
    $('#not-basic').click(function(){
      $.gritter.add({
        ...
        text: "<table><tr><td>asdf</td><td>asdfasdf</tr></table><b>You</b> have a new Thomas message, let's checkout your inbox.",
    ...
    $('#not-text').click(function(){
      $.gritter.add({
        title: 'Just Text',
        text: '<b>This</b> is a simple Gritter Notification. Etiam efficitur efficitur nisl eu dictum, nullam non orci elementum.',
        class_name: 'clean',
        time: ''
      });
      return false;
    ...
    $('#not-tr').click(function(){
      ...
      $.gritter.add({
        title: 'Top Right',
        text: 'This is a simple Gritter Notification. Etiam efficitur efficitur nisl eu dictum, nullam non orci elementumThis is a simple Gritter Notification. Etiam efficitur efficitur nisl eu dictum, nullam non orci elementumThis is a simple Gritter Notification. Etiam efficitur efficitur nisl eu dictum, nullam non orci elementum',
        class_name: 'clean'
      });
